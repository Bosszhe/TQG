...
#         self.conv1_2 = nn.Conv2d(channel, channel//4, kernel_size=3, stride=2, padding=0)
...
#         self.deconv2_3 = nn.ConvTranspose2d(channel//4, channel, kernel_size=3, stride=2, padding=0, output_padding=1)
#         self.bn2_3 = nn.BatchNorm2d(channel, track_running_stats=True)
...
class PointPillarIntermediateFFNet(nn.Module):
    def __init__(self, args):
        super(PointPillarIntermediateFFNet, self).__init__()
        print('PointPillarIntermediateFFNet.__init__')
