...
class DETR3DPostprocessor(BasePostprocessor):
    def __init__(self, anchor_params, train):
        super(DETR3DPostprocessor, self).__init__(anchor_params, train)
    ...
    def post_process(self, data_dict, output_dict):
        ...
        for cav_id, cav_content in data_dict.items():
            ...
            boxes3d =  output_dict['ego'][0]['pts_bbox']['boxes_3d'].tensor.to(transformation_matrix.device)
            scores = output_dict['ego'][0]['pts_bbox']['scores_3d'].to(transformation_matrix.device)
            # # (H, W, anchor_num, 7)
