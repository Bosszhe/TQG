...
class EarlyFusionDatasetDETR3D(basedataset_backup.BaseDataset):
    """
    This dataset is used for early fusion, where each CAV transmit the raw
    point cloud to the ego vehicle.
    """
    def __init__(self, params, visualize, train=True):
        super(EarlyFusionDatasetDETR3D, self).__init__(params, visualize, train)
    ...
    def collate_batch_test(self, batch):
        ...
        for cav_id, cav_content in batch.items():
            ...
            gt_bboxes_3d = [cav_content['gt_bboxes_3d']]
            gt_labels_3d = [torch.from_numpy(cav_content['gt_labels_3d'])]
